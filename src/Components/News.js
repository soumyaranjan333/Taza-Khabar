...
class News extends Component {
  ...
  //       urlToImage:
  //         "https://ichef.bbci.co.uk/news/1024/branded_news/5F04/production/_120242342_tidypicture.jpg",
  ...
  //       urlToImage:
  //         "https://cdn.cnn.com/cnnnext/dam/assets/210219081655-02-bitcoin-file-super-tease.jpg",
  ...
  //       urlToImage:
  //         "https://static01.nyt.com/images/2021/09/05/multimedia/05weekender-storms-promo/merlin_194189808_c3db593f-b5ff-482a-b95e-082b91849f9c-facebookJumbo.jpg",
  //       publishedAt: "2021-09-05T10:14:50Z",
  //       content:
  //         "8. Were just days into September, and its time to start thinking about your spring garden.\r\nRather than following the common practice of planting and transplanting in spring, Rebecca McMackin, the di… [+494 chars]",
  //     },
  //     {
  //       source: { id: "reuters", name: "Reuters" },
  //       author: null,
  //       title:
  //         "Crypto platform Bitso working with El Salvador on Chivo digital wallet - Reuters",
  //       description:
  //         'Fintech Bitso, a cryptocurrency platform, said on Tuesday it will be the core service provider for Chivo, the bitcoin digital wallet launched in El Salvador as it becomes the first country in the world to <a href="https://www.reuters.com/business/finance/el-s…',
  //       url: "https://www.reuters.com/technology/crypto-platform-bitso-working-with-el-salvador-chivo-digital-wallet-2021-09-07/",
  //       urlToImage:
  //         "https://www.reuters.com/resizer/nrP-KTAfCsWqzyMXEkhl8U9ez5o=/1200x628/smart/filters:quality(80)/cloudfront-us-east-2.images.arcpublishing.com/reuters/QJ5TJE4E45K65B22ENEC7NWOEI.jpg",
  //       publishedAt: "2021-09-07T16:38:00Z",
  //       content:
  //         "A representation of cryptocurrency Bitcoin is seen in this illustration taken August 6, 2021. REUTERS/Dado Ruvic/Illustration/File Photo/File Photo/File Photo/File PhotoSept 7 (Reuters) - Fintech Bit… [+1978 chars]",
  //     },
  //     {
  ...
  //       description:
  //         "Payment platform offers service for bitcoin, ethereum, litecoin and bitcoin cashPayPal is to allow users in the UK to buy, hold and sell cryptocurrencies through the payment platform for the first time.The firm said it would allow customers to choose from fou…",
  //       url: "https://amp.theguardian.com/technology/2021/aug/23/paypal-uk-buy-sell-cryptocurrencies-bitcoin-ethereum-litecoin",
  //       urlToImage:
  //         "https://i.guim.co.uk/img/media/9cc3755117074a7ad081b2f74a3d5223732e973c/0_300_6000_3600/master/6000.jpg?width=1200&height=630&quality=85&auto=format&fit=crop&overlay-align=bottom%2Cleft&overlay-width=100p&overlay-base64=L2ltZy9zdGF0aWMvb3ZlcmxheXMvdGctZGVmYXVsdC5wbmc&enable=upscale&s=60b96ea8c4342dd260580796b02553dd",
  ...
  //       description:
  //         "T-Mobile will offer two years of free identity theft protection services after hackers stole data on roughly 49 million customers and potential customers, according to a statement from the mobile carrier. The data breach only became public over the past weeke…",
  //       url: "https://gizmodo.com/t-mobile-offers-free-identity-theft-protection-after-ha-1847507318",
  //       urlToImage:
  //         "https://i.kinja-img.com/gawker-media/image/upload/c_fill,f_auto,fl_progressive,g_center,h_675,pg_1,q_80,w_1200/8151c000e59854d269735184dd72875d.jpg",
  //       publishedAt: "2021-08-18T08:00:00Z",
  //       content:
  //         "T-Mobile will offer two years of free identity theft protection services after hackers stole data on roughly 49 million customers and potential customers, according to a statement from the mobile car… [+2971 chars]",
  //     },
  //     {
  //       source: { id: "reuters", name: "Reuters" },
  ...
  //       urlToImage:
  //         "https://static.reuters.com/resources/r/?d=20210907&i=OVETQ71CB&r=OVETQ71CB&t=2",
  ...
  //       author: "Diego Oré",
  //       title:
  //         "Bitcoin fever reaches Honduras with first cryptocurrency ATM - Reuters",
  //       description:
  ...
  //       urlToImage:
  //         "https://www.reuters.com/resizer/yNRgg-xK5JYL7WA6wUfsoadS1rE=/1200x628/smart/filters:quality(80)/cloudfront-us-east-2.images.arcpublishing.com/reuters/PHYLK2RW6RI6PGVAFQCQNQ6UEM.jpg",
  //       publishedAt: "2021-08-27T19:04:00Z",
  //       content:
  //         "Aug 27 (Reuters) - The first cryptocurrency ATM in Honduras opened this week as bitcoin backers sought to spur demand for virtual assets after neighboring El Salvador became the first country to esta… [+1733 chars]",
  //     },
  //     {
  //       source: { id: "reuters", name: "Reuters" },
  //       author: "Diego Oré",
  ...
  //       content:
  //         "Aug 27 (Reuters) - The first cryptocurrency ATM in Honduras opened this week as bitcoin backers sought to spur demand for virtual assets after neighboring El Salvador became the first country to esta… [+1669 chars]",
  //     },
  //     {
  //       source: { id: "reuters", name: "Reuters" },
  //       author: "Reuters Editorial",
  ...
  //       urlToImage:
  //         "https://static.reuters.com/resources/r/?d=20210907&i=RCV00A6OF&r=RCV00A6OF&t=2",
  ...
  //       description:
  //         "Twitter's latest beta update introduces support for providing content creators with Bitcoin tips using the \"Tip Jar\" feature that Twitter introduced earlier this year. Bitcoin isn't yet available to select as a tip option for beta users, but code in the beta …",
  //       url: "https://www.macrumors.com/2021/08/31/twitter-beta-ios-bitcoin-tips/",
  //       urlToImage:
  //         "https://images.macrumors.com/t/zGJT0ZrIO4SuirGJ9Q4EBKMN3Bs=/2250x/https://images.macrumors.com/article-new/2021/03/Twitter-Feature.jpg",
  //       publishedAt: "2021-08-31T20:07:29Z",
  //       content:
  //         "Twitter's latest beta update introduces support for providing content creators with Bitcoin tips using the \"Tip Jar\" feature that Twitter introduced earlier this year. Bitcoin isn't yet available to … [+1516 chars]",
  //     },
  //     {
  ...
  //       description:
  //         "<ol><li>Bitcoin Crashes as El Salvador Adoption Price Pump Falters  BNN\r\n</li><li>What El Salvador's bitcoin rollout could mean for mainstream adoption  CNBC Television\r\n</li><li>Bitcoin price sees 10k swings as cryptocurrency becomes legal tender in El Salva…",
  //       url: "http://www.bnnbloomberg.ca/bitcoin-crashes-as-el-salvador-adoption-price-pump-falters-1.1648942",
  //       urlToImage:
  //         "http://www.bnnbloomberg.ca/polopoly_fs/1.1648806!/fileimage/httpImage/image.jpg_gen/derivatives/landscape_620/an-employee-selects-the-buy-bitcoin-option-on-a-cryptocurrency-automated-teller-machine-atm-during-a-demonstration-at-the-hong-kong-digital-asset-exchange-ltd-digital-currency-trading-store-in-hong-kong-china-on-thursday-june-24-2021-hong-kong-digital-asset-exchange-is-a-cryptocurrency-platform-and-is-the-first-to-combine-online-and-physical-exchange-in-hong-kong-photographer-bloomberg-bloomberg.jpg",
  //       publishedAt: "2021-09-07T15:43:08Z",
  //       content:
  //         "Bitcoin plunged as much as 17 per cent to its lowest level in a month as El Salvadors crypto rollout got off to a rocky start. \r\nThe largest cryptocurrency fell as low as US$43,050 in New York Tuesda… [+4328 chars]",
  //     },
  //     {
  //       source: { id: "financial-post", name: "Financial Post" },
  //       author: "Bloomberg News",
  //       title:
  //         "Bitcoin crashes as El Salvador rollout, price pump falter - Financial Post",
  //       description:
  //         "<ol><li>Bitcoin crashes as El Salvador rollout, price pump falter  Financial Post\r\n</li><li>Bitcoin, now legal tender in El Salvador, greeted with tech problems, volatility concerns  CBC.ca\r\n</li><li>Salvador street protest breaks out against bitcoin adoption…",
  //       url: "https://financialpost.com/fp-finance/cryptocurrency/bitcoin-crashes-as-el-salvador-adoption-price-pump-falters",
  //       urlToImage:
  //         "https://smartcdn.prod.postmedia.digital/financialpost/wp-content/uploads/2021/09/vw0907bitcoin-el-salvador.jpg",
  //       publishedAt: "2021-09-07T16:05:52Z",
  //       content:
  //         'Plunges as much as 17 per cent to US$43,050 \r\nA woman holds a banner that reads "No to bitcoin" during a demonstration against the circulation of bitcoin in San Salvador, on Sept. 7, 2021.Photo by Ma… [+5898 chars]',
  //     },
  //     {
  //       source: { id: "engadget", name: "Engadget" },
  //       author: "Jon Fingas",
  //       title: "T-Mobile investigates claims of giant customer data breach",
  //       description:
  //         "T-Mobile is grappling with yet another reported data breach. The carrier told Motherboard in a statement that it's investigating an \"underground forum\" member's claims that they're selling data for over 100 million customers, including social security numbers…",
  //       url: "https://www.engadget.com/t-mobile-data-breach-investigation-202913474.html",
  //       urlToImage:
  //         "https://s.yimg.com/os/creatr-uploaded-images/2021-08/86bb4930-fe03-11eb-850f-41793e0d4d92",
  //       publishedAt: "2021-08-15T20:29:13Z",
  //       content:
  //         "T-Mobile is grappling with yet another reported data breach. The carrier told Motherboard in a statement that it's investigating an \"underground forum\" member's claims that they're selling data for o… [+1118 chars]",
  //     },
  //     {
  ...
  //       description:
  //         "PayPal is making its first international crypto expansion with new services for Bitcoin, Ethereum, Litecoin, and Bitcoin Cash in the UK.",
  //       url: "https://www.businessinsider.com/paypal-expands-cryptocurrency-services-into-uk-2021-8",
  //       urlToImage:
  //         "https://i.insider.com/60f16e5a016a320018836973?width=1200&format=jpeg",
  //       publishedAt: "2021-08-24T13:51:00Z",
  //       content:
  //         "PayPal launched its crypto services in the UKits first international crypto expansion, according to a press release.\r\nPayPal's total payment volume reached $311 billion in Q2 2021.\r\nInsider Intellige… [+2125 chars]",
  //     },
  //   ];
  state = {
  ...
  async updateNews(){
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=44963f81e15f4fa1850e09046f660545&page=${this.state.page}&pageSize=${this.props.pageSize}`;
  ...
  async componentDidMount() {
    // let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=44963f81e15f4fa1850e09046f660545&page=1&pageSize=${this.props.pageSize}`;
    // this.setState({ loading: true });
    // let data = await fetch(url);
    // let parsedData = await data.json();
    // // console.log(parsedData)
  ...
  handleNextClick = async () => {
    ...
    //   }&category=${
    //     this.props.category
    //   }&apiKey=44963f81e15f4fa1850e09046f660545&page=${
    //     this.state.page + 1
    //   }&pageSize=${this.props.pageSize}`;
    //   this.setState({ loading: true });
    //   let data = await fetch(url);
    //   let parsedData = await data.json();
    //   // console.log(parsedData)this.setState({ articles: parsedData.articles });
    //   this.setState({
  ...
  render() {
    return (
      <div className="container">
        <h1 className="text-center my-3 text-danger text-decoration-underline">
          Top Headlines
        </h1>
        {this.state.loading && <Spinner />}
        <div className="row row-cols-1 row-cols-md-4 row-cols-sm-2 g-4 my-3">
          {!this.state.loading &&
